...
class Goblin(Object.Object):
    def __init__(self, x, y, player = Player.Player):
        ...
        # flower enemy image
        self.spr_idle = pygame.image.load("../sprites/Goblin/Idle.png").convert_alpha()        # 0
        self.spr_walk = pygame.image.load("../sprites/Goblin/Walk.png").convert_alpha()        # 1
        self.spr_attack = pygame.image.load("../sprites/Goblin/Attack.png").convert_alpha()    # 2
        self.spr_death = pygame.image.load("../sprites/Goblin/Death.png").convert_alpha()      # 3
        self.spr_hit = pygame.image.load("../sprites/Goblin/Hit.png").convert_alpha()          # 4

        # flower enemy sound
        self.sound_attack = pygame.mixer.Sound("../sounds/Goblin/Attack.mp3")
        self.sound_death = pygame.mixer.Sound("../sounds/Goblin/Death.mp3")
        self.sound_hit = pygame.mixer.Sound("../sounds/Goblin/Hit.mp3")
        self.sound_walk = pygame.mixer.Sound("../sounds/Goblin/Walk.mp3")
