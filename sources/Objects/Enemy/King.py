...
class King(Object.Object):
    def __init__(self, x, y, player = Player.Player):
        ...
        # flower enemy image
        self.spr_idle = pygame.image.load("../sprites/King/Idle.png").convert_alpha()        # 0
        self.spr_walk = pygame.image.load("../sprites/King/Run.png").convert_alpha()         # 1
        self.spr_attack1 = pygame.image.load("../sprites/King/Attack1.png").convert_alpha()  # 2
        self.spr_attack2 = pygame.image.load("../sprites/King/Attack2.png").convert_alpha()  # 3
        self.spr_attack3 = pygame.image.load("../sprites/King/Attack3.png").convert_alpha()  # 4
        self.spr_death = pygame.image.load("../sprites/King/Death.png").convert_alpha()      # 5
        self.spr_hit = pygame.image.load("../sprites/King/Hit.png").convert_alpha()          # 6
