...
class Demon(Object.Object):
    def __init__(self, x, y, player = Player.Player):
        ...
        # flower enemy image
        self.spr_idle = pygame.image.load("../sprites/Demon/demon_sprite_sheet.png").convert_alpha()            # 0
        self.spr_walk = pygame.image.load("../sprites/Demon/demon_sprite_sheet.png").convert_alpha()         # 1
        self.spr_attack = pygame.image.load("../sprites/Demon/demon_sprite_sheet.png").convert_alpha()       # 2
        self.spr_death = pygame.image.load("../sprites/Demon/demon_sprite_sheet.png").convert_alpha()        # 3
        self.spr_hit = pygame.image.load("../sprites/Demon/demon_sprite_sheet.png").convert_alpha()          # 4

        # flower enemy sound
        self.sound_attack = pygame.mixer.Sound("../sounds/Demon/Attack.mp3")
        self.sound_death = pygame.mixer.Sound("../sounds/Demon/Death.mp3")
        self.sound_hit = pygame.mixer.Sound("../sounds/Demon/Hit.mp3")
        self.sound_walk = pygame.mixer.Sound("../sounds/Demon/Walk.mp3")
    ...
    def set_sprite(self):
        ...
        # state is idle
        for i in range(0, 6):
            lis.append(self.spr_idle.subsurface(i * self.spr_width, 0 * self.spr_height, self.spr_width, self.spr_height))
        self.spr_list.append(lis[:])
        lis.clear()

        # state is walk
        for i in range(0, 12):
            lis.append(self.spr_walk.subsurface(i * self.spr_width, 1 * self.spr_height, self.spr_width, self.spr_height))
        self.spr_list.append(lis[:])
        lis.clear()

        # state is attack
        for i in range(0, 15):
            lis.append(self.spr_attack.subsurface(i * self.spr_width, 2 * self.spr_height, self.spr_width, self.spr_height))
        self.spr_list.append(lis[:])
        lis.clear()

        # state is death
        for i in range(0, 22):
            lis.append(self.spr_death.subsurface(i * self.spr_width, 4 * self.spr_height, self.spr_width, self.spr_height))
        self.spr_list.append(lis[:])
        lis.clear()

        # state is hit
        for i in range(0, 5):
            lis.append(self.spr_hit.subsurface(i * self.spr_width, 3 * self.spr_height, self.spr_width, self.spr_height))
        self.spr_list.append(lis[:])
        lis.clear()
    ...
    def draw_image(self):
        ...
        if not self.is_enemy_die:
            ...
            sprite = pygame.transform.scale(
                pygame.transform.flip(self.spr_list[self.state_index][math.floor(self.spr_index)], not self.direction,
                                      False),
