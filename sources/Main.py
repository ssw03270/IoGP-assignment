...
def draw_level(tileset = Tileset.Tileset, level = int, delta_time = int, player = Player):
    if level == 0:
        ...
        content = " 사무라이는 꽤나 버거운 상대였지만 역시나 이번에도 기사가 승리했다. \n사무라이의 품안에는 말린 다랑어가 하나 있었다. \n\n" \
        ...
        content = " 마법사가 소환하는 해골 탓에 꽤나 성가셨지만 기사는 어찌어찌 쳐치하는데\n 성공했다. 역시나 기사는 배고픔을 해결하기 위해 마법사의 옷을 뒤적였다.\n\n" \
